...
mnist_pca_100_train = pca_100.fit_transform(train_images_standardized) 
mnist_pca_100_test = pca_100.transform(test_images_standardized) 

#MNIST compressed data 
X_train = mnist_pca_100_train 
X_test = mnist_pca_100_test 
y_train = train_images_label 
y_test = test_images_label 
